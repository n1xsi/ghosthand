...
### 🎨 Visuals (Внешний вид)
* **Sound Esp** – Отрисовка стрелок на экране по кругу от прицела в сторону, откуда пришёл звук.
* **Watermark** – Стильная плашка на экране с версией и статусом софта, временем и системными мониторами (нагрузка на CPU/GPU/RAM и общий Ping).
* **Theme** – Система тем для меню GhostHand (есть пресеты, кастомная настройка каждого элемента меню и сброс темы). 
...
<details>
  ...
  * <img src="https://shared.fastly.steamstatic.com/community_assets/images/apps/30/aadc0ce51ff6ba2042d633f8ec033b0de62091d0.jpg" align="top"> Day of Defeat *(ez server AC)*
